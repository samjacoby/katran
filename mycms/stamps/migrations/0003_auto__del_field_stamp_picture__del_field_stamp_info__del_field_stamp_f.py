...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('stamps_stamp', 'picture_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('stamps_stamp', 'picture', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stamp_picture', null=True, to=orm['cms.Placeholder']), keep_default=False)
