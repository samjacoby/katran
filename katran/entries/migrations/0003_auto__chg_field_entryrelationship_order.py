...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryRelationship.order'
        db.alter_column('entries_entryrelationship', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'EntryRelationship.order'
        db.alter_column('entries_entryrelationship', 'order', self.gf('django.db.models.fields.PositiveIntegerField')())
