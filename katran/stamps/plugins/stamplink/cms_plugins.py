...
from stamps.plugins.stamplink.forms import StampLinkForm

class StampLinkPlugin(CMSPluginBase):
    model = StampLink
    form = StampLinkForm
    name = _("Stamp Link")
    ...
    def get_form(self, request, obj=None, **kwargs):
        Form = super(StampLinkPlugin, self).get_form(request, obj, **kwargs)
...
plugin_pool.register_plugin(StampLinkPlugin)
