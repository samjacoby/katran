...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('stamps_sponsor', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Sponsor.normalized_name'
        db.add_column('stamps_sponsor', 'normalized_name', self.gf('django.db.models.fields.CharField')(default='hello', max_length=100), keep_default=False)

        # Changing field 'Sponsor.link'
        db.alter_column('stamps_sponsor', 'link', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('stamps_sponsor', 'active')

        # Deleting field 'Sponsor.normalized_name'
        db.delete_column('stamps_sponsor', 'normalized_name')

        # Changing field 'Sponsor.link'
        db.alter_column('stamps_sponsor', 'link', self.gf('django.db.models.fields.CharField')(max_length=100))
